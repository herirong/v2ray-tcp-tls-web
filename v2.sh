...
checkIP() {
  local realIP="$(curl -s `curl -s https://raw.githubusercontent.com/herirong/v2ray-tcp-tls-web/master/custom/ip_api`)"
...
EOF
  ...
  wget -q https://raw.githubusercontent.com/herirong/v2ray-tcp-tls-web/${branch}/config/v2ray.json -O /tmp/v2ray.json
  ...
  wget -q https://raw.githubusercontent.com/herirong/v2ray-tcp-tls-web/${branch}/config/tls-shunt-proxy.yaml -O /tmp/config_new.yaml
  ...
  local template="$(curl -s https://raw.githubusercontent.com/herirong/web-templates/master/list.txt | shuf -n  1)"
  wget -q https://raw.githubusercontent.com/herirong/web-templates/master/${template}
